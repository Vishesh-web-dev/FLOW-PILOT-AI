...
import { decryptPasswordFields } from "../middleware/decryptPassword";
...
router.post("/register", decryptPasswordFields, validate(registerSchema), authController.register);
router.post("/login", decryptPasswordFields, validate(loginSchema), authController.login);
router.post("/demo", authController.demoLogin);

// Protected routes
router.get("/me", authenticate, authController.getMe);
router.put("/profile", authenticate, authController.updateProfile);
router.put("/password", authenticate, decryptPasswordFields, authController.changePassword);
