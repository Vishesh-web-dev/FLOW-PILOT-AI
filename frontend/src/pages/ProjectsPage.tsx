...
import { Plus, Folder, Trash2, Edit3, Layers, Kanban } from "lucide-react";
    ...
    <div className="animate-fade-in-up" style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      <div style={{ display: "flex", gap: 16 }}>
        {[
          ...
          { label: "On Hold", count: projects.filter((p) => p.status === "ON_HOLD").length, color: "#f59e0b" },
      ...
      {isLoading ? (
        ...
        >
          {projects.map((project) => {
            const taskCount = (project as Project & { _count?: { tasks: number; sprints: number } })._count?.tasks || 0;
            const sprintCount = (project as Project & { _count?: { tasks: number; sprints: number } })._count?.sprints || 0;
            ...
            return (
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  (e.currentTarget as HTMLDivElement).style.boxShadow = `0 8px 32px ${color}20`;
                }}
                onMouseLeave={(e) => {
                  ...
                  >
                    ...
                    <div style={{ display: "flex", gap: 4 }}>
                      ...
                      <Popconfirm
                        ...
                        description="All tasks in this project will be unlinked."
                        onConfirm={(e) => { e?.stopPropagation(); deleteMutation.mutate(project.id); }}
                        okText="Delete"
      ...
      >
        <Form form={form} layout="vertical" onFinish={handleSubmit} style={{ marginTop: 16 }}>
          <Form.Item
            name="name"
            label={<span style={{ color: "#94a3b8", fontSize: 13 }}>Project Name</span>}
            rules={[{ required: true, message: "Name is required" }]}
          >
            <Input
              placeholder="e.g. Product Redesign Q1"
              style={{
                background: "#1c1c28",
          ...
          <div style={{ display: "flex", gap: 16 }}>
            <Form.Item
              name="color"
              label={<span style={{ color: "#94a3b8", fontSize: 13 }}>Color</span>}
              style={{ flex: 1 }}
            >
              <Select
